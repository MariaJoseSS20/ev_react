...
export default function Indicadores() {
  ...
  return (
    <main className="container py-4">
      <h1 className="h3 mb-2">Indicadores económicos (Actividad 2)</h1>
      <p className="text-muted small mb-3">
        Datos desde{' '}
        <a href="https://www.mindicador.cl/" target="_blank" rel="noopener noreferrer">
          mindicador.cl
        </a>
        . Ingresa una cantidad y calcula el equivalente en pesos chilenos.
      </p>
              ...
              return (
                <div key={item.codigo} className="col-md-4">
                  <div className="card p-3 h-100">
                    ...
                    {info?.fecha && (
                      <p className="small text-muted mb-0 mt-1">Fecha: {info.fecha}</p>
                    )}
                  </div>
                </div>
              );
